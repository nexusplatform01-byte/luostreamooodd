...
export const categoryData: Record<string, CategoryInfo> = {
  drama: { id: 'drama', title: 'TV DRAMA', subtitle: 'LUO TRANSLATED DRAMAS — ANCIENT COSTUME, ROMANCE, CRIME, FAMILY', color: '#c0392b', gradient: 'linear-gradient(135deg, #1a0a0a, #2d0a0a)', filters: ['ALL DRAMAS', 'ANCIENT COSTUME', 'MODERN', 'ROMANCE', 'CRIME', 'FAMILY', 'COMEDY', 'THRILLER', 'FANTASY', 'HISTORICAL', 'WUXIA', 'XIANXIA', 'K-DRAMA', 'MEDICAL', '2025', '2024'], cards: dramaCards },
  anime: { id: 'anime', title: 'ANIME', subtitle: 'LUO DUBBED ANIME — ACTION, XIANXIA, ROMANCE, SCHOOL, MECHA', color: '#1565c0', gradient: 'linear-gradient(135deg, #0a0a1a, #0a0d2d)', filters: ['ALL ANIME', 'ACTION', 'ROMANCE', 'XIANXIA', 'SPORTS', 'COMEDY', 'MECHA', 'SCI-FI', 'HORROR', 'FANTASY', 'SCHOOL LIFE', 'ISEKAI', 'SHOUNEN', 'SHOUJO', '2025', '2024'], cards: animeCards },
  movies: { id: 'movies', title: 'MOVIES', subtitle: 'LUO TRANSLATED MOVIES — BLOCKBUSTERS, ACTION, ROMANCE, HORROR, SCI-FI', color: '#c07800', gradient: 'linear-gradient(135deg, #1a1200, #2d1e00)', filters: ['ALL FILMS', 'ACTION', 'COMEDY', 'ROMANCE', 'THRILLER', 'SCI-FI', 'HORROR', 'FANTASY', 'CRIME', 'DRAMA', 'ANIMATION', 'DOCUMENTARY', 'FAMILY', 'MUSICAL', 'WESTERN', 'ADVENTURE', '2025', '2024'], cards: movieCards },
  variety: { id: 'variety', title: 'VARIETY SHOWS', subtitle: 'LUO DUBBED VARIETY — REALITY, TALENT, COMEDY, COOKING, TRAVEL', color: '#1a7a4a', gradient: 'linear-gradient(135deg, #001a0e, #002d18)', filters: ['ALL VARIETY', 'REALITY', 'TALENT', 'TRAVEL', 'FOOD & COOKING', 'COMEDY', 'MUSIC', 'DATING', 'TALK SHOW', 'GAME SHOW', 'DANCE', '2025', '2024'], cards: varietyCards },
  short: { id: 'short', title: 'SHORT DRAMA', subtitle: 'LUO TRANSLATED SHORT DRAMAS — BINGE-WORTHY MICRO SERIES', color: '#c03060', gradient: 'linear-gradient(135deg, #1a0010, #2d0018)', filters: ['ALL SHORT', 'ROMANCE', 'ACTION', 'COMEDY', 'ANCIENT', 'MODERN', 'FANTASY', 'HORROR', 'THRILLER', 'FAMILY', 'INSPIRATIONAL', '2025', '2024'], cards: dramaCards.slice(0, 8) },
  kids: { id: 'kids', title: 'KIDS', subtitle: 'LUO DUBBED KIDS CONTENT — ANIMATION, EDUCATION, ADVENTURE', color: '#d4800a', gradient: 'linear-gradient(135deg, #1a0e00, #2d1800)', filters: ['ALL KIDS', 'ANIMATION', 'EDUCATION', 'PRESCHOOL', 'ACTION', 'COMEDY', 'ADVENTURE', 'FAIRY TALE', 'MUSIC', 'AGES 0-3', 'AGES 3-6', 'AGES 6-12', 'AGES 12+'], cards: animeCards.slice(3, 8).concat(dramaCards.slice(0, 3)) },
  vip: { id: 'vip', title: 'VIP CENTER', subtitle: 'EXCLUSIVE MEMBER CONTENT — AD-FREE, 4K, OFFLINE DOWNLOAD', color: '#c8a200', gradient: 'linear-gradient(135deg, #1a1400, #2d2300)', filters: ['VIP EXCLUSIVE', 'SVIP EXCLUSIVE', 'VIP MOVIES', 'VIP DRAMA', 'VIP ANIME', 'VIP VARIETY', 'VIP KIDS', 'OFFLINE PLAY', 'AD-FREE', '4K HDR'], cards: [...dramaCards.slice(0, 4), ...movieCards.slice(0, 4)] },
  documentary: { id: 'documentary', title: 'DOCUMENTARY', subtitle: 'LUO DUBBED DOCUMENTARIES — NATURE, HISTORY, CULTURE, SCIENCE', color: '#5a4000', gradient: 'linear-gradient(135deg, #0e0a00, #1a1200)', filters: ['ALL DOCS', 'NATURE', 'HISTORY', 'CULTURE', 'SCIENCE', 'SOCIETY', 'TRAVEL', 'CRIME', 'BIOGRAPHY', 'WILDLIFE', 'SPACE', 'TECHNOLOGY', '2025', '2024'], cards: [...animeCards.slice(4, 8), ...movieCards.slice(1, 5)] },
  sports: { id: 'sports', title: 'SPORTS', subtitle: 'LUO SPORTS CONTENT — FOOTBALL, BASKETBALL, ATHLETICS, ESPORTS', color: '#1560a0', gradient: 'linear-gradient(135deg, #000a1a, #00122d)', filters: ['ALL SPORTS', 'FOOTBALL', 'BASKETBALL', 'TENNIS', 'ATHLETICS', 'RUGBY', 'BOXING', 'SWIMMING', 'ESPORTS', 'EXTREME SPORTS', 'MOTORSPORT', 'HIGHLIGHTS', 'LIVE MATCHES'], cards: movieCards.slice(0, 8) },
  culture: { id: 'culture', title: 'CULTURE & ART', subtitle: 'LUO CULTURAL CONTENT — HISTORY, MUSIC, THEATER, TRADITIONS', color: '#6a3000', gradient: 'linear-gradient(135deg, #0e0800, #1a1000)', filters: ['ALL CULTURE', 'HISTORY', 'MUSIC', 'THEATER', 'PAINTING', 'TRADITION', 'LITERATURE', 'POETRY', 'HERITAGE', 'FOLK ART', 'DANCE', 'CRAFT'], cards: animeCards.slice(0, 8) },
  live: { id: 'live', title: 'LIVE', subtitle: 'LIVE BROADCASTS — NEWS, SPORTS, CONCERTS, EVENTS', color: '#c00000', gradient: 'linear-gradient(135deg, #1a0000, #2d0000)', filters: ['ALL LIVE', 'NEWS', 'SPORTS LIVE', 'CONCERT', 'ESPORTS LIVE', 'VARIETY LIVE', 'DRAMA LIVE', 'EVENTS', 'CHURCH', 'POLITICS'], cards: varietyCards },
  games: { id: 'games', title: 'GAMES', subtitle: 'GAMING CONTENT — MOBILE, PC, ESPORTS, REVIEWS', color: '#00880a', gradient: 'linear-gradient(135deg, #001200, #001e00)', filters: ['ALL GAMES', 'MOBILE', 'PC', 'CONSOLE', 'ESPORTS', 'STRATEGY', 'RPG', 'ACTION', 'PUZZLE', 'SPORTS', 'REVIEWS', 'TUTORIALS'], cards: movieCards.slice(0, 8) },
  learning: { id: 'learning', title: 'LEARNING', subtitle: 'EDUCATION IN LUO — LANGUAGE, SKILLS, EXAM PREP, FINANCE', color: '#1878c8', gradient: 'linear-gradient(135deg, #001018, #001528)', filters: ['ALL LEARNING', 'LANGUAGE', 'EXAM PREP', 'SKILLS', 'FINANCE', 'CODING', 'SCIENCE', 'HISTORY', 'MATH', 'ARTS', 'BUSINESS', 'SELF-IMPROVEMENT'], cards: animeCards },
  knowledge: { id: 'knowledge', title: 'KNOWLEDGE', subtitle: 'SCIENCE, TECH, SPACE, NATURE — IN LUO', color: '#0050a0', gradient: 'linear-gradient(135deg, #000818, #000d28)', filters: ['ALL KNOWLEDGE', 'SCIENCE', 'TECH', 'BIOLOGY', 'SPACE', 'HISTORY', 'ECONOMICS', 'PHILOSOPHY', 'GEOGRAPHY', 'PSYCHOLOGY', 'ENVIRONMENT'], cards: movieCards },
  'new-films': { id: 'new-films', title: 'NEW RELEASES', subtitle: 'JUST DROPPED — LATEST LUO TRANSLATED CONTENT', color: '#b07800', gradient: 'linear-gradient(135deg, #181000, #281800)', filters: ['ALL NEW', 'THIS WEEK', 'THIS MONTH', 'DRAMA', 'ANIME', 'MOVIES', 'VARIETY', 'SHORT', 'DOCUMENTARY', 'KIDS'], cards: [...dramaCards.slice(0, 4), ...movieCards.slice(0, 4)] },
  health: { id: 'health', title: 'HEALTH', subtitle: 'FITNESS, WELLNESS, NUTRITION, MENTAL HEALTH — IN LUO', color: '#008060', gradient: 'linear-gradient(135deg, #001810, #002818)', filters: ['ALL HEALTH', 'FITNESS', 'NUTRITION', 'MENTAL HEALTH', 'YOGA', 'MEDICAL', 'LIFESTYLE', 'WEIGHT LOSS', 'PARENTING', 'SENIOR CARE'], cards: varietyCards },
  charity: { id: 'charity', title: 'CHARITY', subtitle: 'SOCIAL IMPACT, COMMUNITY, PUBLIC GOOD', color: '#c04020', gradient: 'linear-gradient(135deg, #1a0800, #2d1000)', filters: ['ALL CHARITY', 'ENVIRONMENT', 'EDUCATION', 'POVERTY', 'ANIMALS', 'HEALTH', 'DISASTER RELIEF', 'CHILDREN', 'WOMEN', 'COMMUNITY'], cards: movieCards },
  accessible: { id: 'accessible', title: 'ACCESSIBLE', subtitle: 'CONTENT FOR EVERYONE — SUBTITLED, AUDIO DESCRIBED, SIGNED', color: '#404080', gradient: 'linear-gradient(135deg, #080818, #0d0d28)', filters: ['ALL', 'AUDIO DESCRIPTION', 'SUBTITLED', 'SIGNED', 'SIMPLIFIED', 'LARGE TEXT', 'HIGH CONTRAST'], cards: dramaCards },
};
